...
def tampilkan_halaman():
    ...
    with t_masjid_v1:
        ...
        MASTER_FAMILY_WARDROBE = {
            ...
            "Nenek Siti": {
                "Kebaya Kartini Muda (Faded)": "A pale pink traditional kebaya, very old and thin, with soft texture and natural fabric creases.",
                "Daster Batik Cokelat": "A traditional brown batik daster with classic 'parang' patterns, faded from frequent washing.",
                "Baju Harian Sederhana": "A simple button-up long-sleeved shirt in muted grey, worn-out texture, very modest village look.",
                "Kebaya Kutu Baru Lusuh": "A dark maroon traditional Javanese kebaya with a simple chest panel, faded and wrinkled fabric.",
                "Kain Jarik Sogan": "A classic deep brown Javanese jarik cloth worn with a simple thin white undershirt."
            },
            "Nenek Marsi": {
                "Kebaya Hitam Tradisional": "A stark black simple kebaya, heavy fabric texture but looking old and well-kept, paired with a dark batik cloth.",
                "Baju Kurung Motif Kecil": "A dark blue baju kurung with tiny white flower patterns, thin and breathable fabric.",
                "Daster Rayon Adem": "A very thin, loose daster in dark green with abstract traditional patterns, looking very old.",
                "Kebaya Nenek Klasik": "A greyish-blue simple kebaya with a textured surface, looking aged and authentic.",
                "Setelan Sarung Wanita": "A traditional patterned sarung worn high with a simple long-sleeved brown cotton shirt."
            },
            "Nenek Ponirah": {
                "Kebaya Batik Pudar": "A kebaya made from batik fabric with faded red and brown patterns, very soft and thin texture.",
                "Daster Motif Daun": "A dark brown daster with faded green leaf patterns, looking humble and everyday.",
                "Baju Panjang Modest": "A loose, dark grey long-sleeved tunic, simple and practical for daily village life.",
                "Kebaya Cokelat Tua": "A plain dark brown kebaya with visible fabric weave, looking old and sturdy.",
                "Kain Lilit & Blus Sederhana": "A simple navy blouse worn with a faded brown batik wrap-around cloth."
            },
            "Nenek Juminah": {
                "Kebaya Hitam Tipis": "A very thin black cotton kebaya with subtle texture, looking fragile and aged.",
                "Daster Batik Lawasan": "An old Javanese batik daster with faded traditional patterns, very soft fabric.",
                "Kebaya Putih Tulang": "An off-white simple kebaya, slightly yellowed with age, humble and modest.",
                "Batik Jarik & Blus": "A faded brown batik jarik worn with a simple dark blue long-sleeved blouse.",
                "Setelan Rumah Kasar": "A simple, loose-fitting cotton shirt in muted earthy tones."
            },
            "Nenek Sikem": {
                "Daster Jumbo Motif Mega Mendung": "A large, loose batik daster with faded blue cloud patterns, comfortable and well-worn.",
                "Kebaya Jawa Cokelat": "A simple dark brown kebaya with visible fabric weave, looking authentic and aged.",
                "Baju Kurung Motif Bunga Pudar": "A dark red baju kurung with tiny faded flower patterns, thin and soft material.",
                "Kebaya Kutu Baru Hijau": "A dark green Javanese kebaya with a simple chest panel, looking old and humble.",
                "Kain Jarik & Kaos Adem": "A brown batik jarik worn with a simple thin white undershirt."
            },
            "Nenek Dulah": {
                "Kebaya Encim Kuning Muda": "A pale yellow traditional kebaya with subtle embroidery, faded and thin fabric.",
                "Daster Batik Parang": "A traditional brown batik daster with parang patterns, soft from years of washing.",
                "Baju Panjang Modest Grey": "A simple long-sleeved grey tunic, loose and practical for village life.",
                "Kebaya Biru Muda Pudar": "A light blue simple kebaya, looking very old with soft fabric creases.",
                "Kain Lilit & Blus Putih": "A simple white blouse worn with a faded red batik wrap-around cloth."
            },
            "Nenek Sartini": {
                "Kebaya Hitam Sederhana": "A plain black cotton kebaya, looking humble and sturdy but showing age.",
                "Daster Motif Abstrak": "A dark green daster with faded abstract patterns, very thin and breathable material.",
                "Baju Kurung Biru Navy": "A plain navy blue traditional baju kurung, modest and well-worn.",
                "Kebaya Cokelat Sogan": "A brown batik kebaya with traditional sogan patterns, looking very authentic.",
                "Setelan Jarik & Kebaya Polos": "A dark grey kebaya paired with a brown batik jarik cloth."
            },
            "Nenek Tinah": {
                "Kebaya Putih Tipis": "A very thin white cotton kebaya, slightly translucent with age, looking very fragile.",
                "Daster Batik Hijau Tua": "A dark green batik daster with faded traditional motifs, soft fabric texture.",
                "Kebaya Cokelat Tua Pudar": "A dark brown simple kebaya, looking aged with visible fabric grain.",
                "Batik Jarik & Blus Hitam": "A faded brown batik jarik worn with a simple black long-sleeved shirt.",
                "Baju Harian Nenek": "A simple, loose-fitting cotton shirt in muted earthy tones."
            },
            "Nenek Wati": {
                "Kebaya Pink Lembut Pudar": "A very pale pink traditional kebaya, thin and soft from age.",
                "Daster Motif Bunga Kecil": "A light blue daster with tiny faded flower patterns, looking humble and everyday.",
                "Baju Panjang Sederhana": "A simple long-sleeved tunic in muted brown, loose and comfortable.",
                "Kebaya Putih Kartini Lusuh": "A white Kartini-style kebaya, looking aged with soft fabric creases.",
                "Kain Lilit & Blus Navy": "A simple navy blue blouse worn with a faded brown batik cloth."
            },
            "Kakek Marto": {
                "Surjan Lurik Cokelat": "A traditional Javanese surjan shirt with brown and black lurik stripes, slightly frayed at the collar, very authentic.",
                "Kemeja Kerja Lusuh": "A faded blue button-up work shirt with sweat stains near the neck, worn-out fabric, looking like a farmer's daily wear.",
                "Baju Koko Tua & Sarung": "A plain white baju koko, slightly yellowed, paired with a faded green plaid sarung worn around the waist.",
                "Kaos Oblong Putih & Sarung": "A simple thin white undershirt (kaos oblong) with a dark brown batik sarung draped over one shoulder.",
                "Baju Pangsi Hitam": "A simple black traditional pangsi shirt, loose-fitting, with visible fabric texture and age."
            },
            "Kakek Somo": {
                "Baju Batik Motif Klasik": "A faded brown batik shirt with large traditional patterns, thin material from years of use.",
                "Kemeja Flanel Tua": "An old, faded plaid flannel shirt in muted red and grey, very soft texture from age.",
                "Kaos Berkerah Lusuh": "A dark green polo shirt, very faded, with a stretched collar and thin material.",
                "Baju Koko Cokelat Muda": "A simple light brown baju koko with minimal embroidery, looking humble and well-worn.",
                "Setelan Celana Komprang": "Loose black traditional trousers paired with a simple thin grey t-shirt."
            },
            "Kakek Joyo": {
                "Baju Batik Parang Rusak": "A classic batik shirt with dark brown parang patterns, faded and very thin fabric.",
                "Kemeja Putih Gading": "A simple ivory white shirt, looking old with slight wrinkles and weathered buttons.",
                "Baju Lurik Hijau Tua": "A dark green Javanese lurik surjan, very authentic with rough fabric texture.",
                "Kaos Rakyat Sederhana": "A simple thin brown t-shirt with a loose neck, looking very modest and daily.",
                "Sarung Kotak-Kotak & Peci": "A blue plaid sarung paired with a simple black skullcap (peci) that looks slightly faded."
            },
            "Kakek Hardi": {
                "Kemeja Garis-Garis Pudar": "A faded thin shirt with vertical grey stripes, looking very old and delicate.",
                "Baju Koko Putih Bersih": "A simple white baju koko, thin and well-kept but looking aged, very humble.",
                "Kaos Putih & Sarung Batik": "A thin white t-shirt paired with a meticulously wrapped brown batik sarung.",
                "Baju Katun Cokelat": "A plain brown cotton shirt with a rough texture and natural creases.",
                "Setelan Pakaian Shalat": "A simple long-sleeved white shirt with a dark green sarung, looking peaceful and elderly."
            },
            "Kakek Sableng": {
                "Baju Hitam Polos Lusuh": "A plain black cotton shirt, faded to a dark grey tone, looking rough and weathered.",
                "Kemeja Batik Merah Tua": "A deep maroon batik shirt with faded patterns, very thin and soft fabric.",
                "Baju Kerja Petani": "A simple dark blue long-sleeved shirt with visible wear marks and aged texture.",
                "Kaos Loreng Pudar": "A very faded camouflage-patterned t-shirt, looking like an old veteran's casual wear.",
                "Sarung Dikalungkan": "A simple dark plaid sarung worn over a thin grey undershirt, looking very authentic."
            },
            "Kakek Sinto": {
                "Surjan Lurik Hijau": "A dark green traditional surjan with subtle lurik patterns, looking aged and authentic.",
                "Kemeja Putih Lusuh": "A simple white button-up shirt, looking old with slight yellowing and weathered buttons.",
                "Kaos Oblong & Sarung": "A thin white undershirt paired with a faded brown batik sarung.",
                "Baju Koko Abu-Abu Tua": "A plain dark grey baju koko, simple and modest with weathered texture.",
                "Pakaian Harian Desa": "A loose brown cotton shirt with visible fabric weave and aging marks."
            },
            "Kakek Wiryo": {
                "Baju Batik Motif Lawasan": "A classic batik shirt with faded earthy patterns, very soft and thin from age.",
                "Kemeja Kerja Biru Tua": "A dark blue rugged work shirt with visible wear and aged texture.",
                "Kaos Cokelat & Sarung": "A simple thin brown t-shirt with a dark plaid sarung worn around the waist.",
                "Baju Koko Putih Lusuh": "A plain white baju koko, looking old and humble with natural creases.",
                "Surjan Lurik Hitam": "A stark black surjan with thin grey lurik stripes, looking traditional and sturdy."
            },
            "Kakek Usman": {
                "Baju Koko Abu-Abu": "A simple grey baju koko with a soft texture, looking humble and aged.",
                "Kemeja Batik Biru": "A faded blue batik shirt with white patterns, thin material with visible creases.",
                "Baju Putih Lengan Pendek": "A simple white short-sleeved shirt, slightly yellowed, looking very modest.",
                "Kaos Cokelat Tua": "A plain dark brown t-shirt with a worn-out texture and soft material.",
                "Setelan Sarung & Koko": "A dark maroon sarung paired with a simple light grey baju koko."
            }
        }
