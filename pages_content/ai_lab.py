...
def tampilkan_halaman():
    ...
    with t_masjid_v1:
        ...
        if btn_gen:
			...
			if is_perempuan:
                gender_lock = (
                    "IDENTITY: Extremely fragile Indonesian grandmother (90+). " # Naikin umurnya biar Grok nangkep
                    ...
                    "WARDROBE: Old, faded, dust-stained village hijab (kerudung) showing realistic wear and tear." # Hijabnya dibikin kusam/berdebu
                )
            else:
                gender_lock = (
                    "IDENTITY: Extremely frail Indonesian grandfather (90+). " # Naikin umurnya
                    "FACE: Skeletal facial structure, sun-damaged leathery skin, deep sunken hollow cheeks, and prominent bone ridges. "
                    "WARDROBE: Old, weathered, slightly discolored black Indonesian kopiah/peci with visible age." # Peci-nya dibikin kusam
                )
            ...
            final_ai_prompt = (
                ...
                f"VOICE PROFILE:\n"
                f"{'Elderly Female' if is_perempuan else 'Elderly Male'} (Extremely frail 90+ years old). " # Ganti ke 90+
                f"MANDATORY: Shaky, thin, and gasping vocal texture. " # Tambah gasping
                f"Include heavy audible breathing, weary pauses, and realistic vocal fry of a very old person. " # Tambah vocal fry
