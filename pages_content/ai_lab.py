    ...
    with t_masjid_v1:
        ...
        MASTER_KONTEN_ALL = {
            "🍉 Miniatur Dari Buah": {
                ...
                "Semangka: Ukiran Tipis Presisi": (
                    "An ultra-precise miniature mosque carved from a whole watermelon, placed on a rustic wooden table. "
                    "The structure is defined by extremely thin carving work, where the green rind is shaved down to delicate architectural thickness while maintaining structural integrity. "
                    "Domes and minarets are slender and refined, with very fine edges and highly controlled carving depth. "
                    "Certain sections reveal very thin layers of white rind above dense red flesh, showing subtle material transitions without any translucency. "
                    "The red flesh remains dense, opaque, fibrous, and non-translucent, with a matte moist surface that absorbs light naturally. "
                    "Surface behavior strictly follows real fruit physics: no glow, no subsurface lighting, no emission, no light passing through. "
                    "Highly intricate geometric Islamic patterns are carved with extreme precision, emphasizing craftsmanship and symmetry. "
                    "Edges are sharp but include micro-imperfections consistent with real hand carving at a delicate scale. "
                    "The wooden table surface is covered with fine carving residue: thin rind curls, micro shavings, scattered seeds, and light juice traces. "
                    "Strictly photorealistic food carving, no stylization, no artificial lighting, no cinematic effects. "
                    "Pure ornamental structure with no text or calligraphy."
                ),
                "Semangka: Ukiran Tradisional": (
                    "A roughly carved miniature mosque sculpted from a whole watermelon, placed on a rustic wooden table. "
                    "The structure features a large dome and multiple minarets, but with visibly uneven carving and imperfect geometry, reflecting traditional hand-cut techniques. "
                    "The green rind walls are thick and irregular, with arches and openings carved in a less precise, more organic manner. "
                    "Exposed red flesh appears rough, fibrous, and unevenly cut, with visible tearing, juice pooling, and embedded seeds. "
                    "The flesh is dense, opaque, and fully non-translucent, with a matte wet texture that does not emit or transmit light. "
                    "Surface behavior follows real fruit physics: no glow, no subsurface scattering, no translucency, no emission. "
                    "Lighting is purely external and natural, interacting with rough, uneven surfaces. "
                    "Minimal geometric ornamentation, with more focus on raw carving marks and tool traces. "
                    "The wooden table is messy and heavily covered with carving debris: large chunks of flesh, broken rind pieces, scattered seeds, and visible juice stains. "
                    "Strictly realistic, non-stylized, no artificial lighting or enhancement. "
                    "Pure ornamental structure with no text or calligraphy."
                ),
                "Semangka: Modular Block": (
                    "A miniature mosque constructed from multiple carved watermelon pieces assembled into a cohesive structure, placed on a rustic wooden table. "
                    ...
                    "Exposed red flesh appears dense, fibrous, and irregular, with visible grain, seeds, and moisture variation. "
                    "All materials remain physically solid and opaque, with no translucency or light emission. "
                    "Surface behavior strictly follows real fruit physics: no glow, no subsurface scattering, no internal lighting. "
                    "Geometric Islamic patterns are lightly carved onto selected surfaces, maintaining symmetry across assembled parts. "
                    "The wooden table surface is scattered with cut fragments, loose segments, seeds, and juice marks from the assembly process. "
                    "Strictly photorealistic, non-stylized, no artificial lighting or enhancement. "
                    "Pure ornamental structure with no text or calligraphy."
                ),
                "Semangka: Setengah Berukir": (
                    "A partially completed miniature mosque carved from a whole watermelon, placed on a rustic wooden table. "
                    "One side of the structure is fully carved with domes, minarets, and detailed arches, while the other side remains raw and uncarved, showing the original smooth watermelon surface. "
                    "The contrast highlights the carving process, with visible tool marks, uneven cuts, and progressive shaping stages. "
                    "Exposed red flesh appears dense, fibrous, and naturally moist, with seeds embedded and irregular texture. "
                    "The flesh is fully opaque and non-translucent, with no light emission or glow. "
                    "Surface behavior follows real fruit material physics: no subsurface lighting, no translucency, no artificial effects. "
                    "Lighting is strictly external and natural, interacting with both carved and uncarved surfaces. "
                    "The wooden table is filled with carving debris: unfinished chunks, rind scraps, seeds, and visible juice trails from active carving. "
                    "Strictly photorealistic, no stylization, no artificial lighting. "
                    "Pure ornamental structure with no text or calligraphy."
                ),
                "Semangka: Kompleks Masjid": (
                    "A large-scale miniature mosque complex carved from a whole watermelon, placed on a rustic wooden table. "
                    "The structure includes a central grand mosque surrounded by smaller satellite buildings, courtyards, and multiple clustered minarets. "
                    "The layout is dense and architectural, resembling a full religious complex rather than a single structure. "
                    "All elements are carved from green rind with exposed red flesh used for depth accents and inner sections. "
                    "The red flesh appears dense, fibrous, and naturally moist, with visible grain and seeds, remaining fully opaque and non-translucent. "
                    "Surface behavior follows real fruit physics: no glow, no subsurface scattering, no internal lighting. "
                    "Highly detailed geometric Islamic patterns unify the entire complex with strong symmetry. "
                    "The wooden table surface is widely covered with carving debris, indicating extensive carving work: flesh chunks, rind fragments, seeds, and juice stains. "
                    "Strictly photorealistic, non-stylized, no artificial lighting or enhancement. "
                    "Pure ornamental structure with no text or calligraphy."
                ),
                "Semangka: Erosi Alami": (
                    "A miniature mosque carved from a whole watermelon with an erosion-inspired style, placed on a rustic wooden table. "
                    "The structure appears partially worn and organically shaped, with softened edges, uneven surfaces, and natural-looking degradation as if carved and then slightly eroded. "
                    "Domes and minarets retain their overall form but show subtle deformation and irregularities. "
                    "Exposed red flesh appears rough, fibrous, and uneven, with natural tearing, juice residue, and embedded seeds. "
                    "The flesh remains dense, opaque, and completely non-translucent, with no light emission or glow. "
                    "Surface behavior follows real fruit physics: no subsurface scattering, no translucency, no artificial lighting. "
                    "Minimal geometric detailing, partially faded or softened due to the erosion concept. "
