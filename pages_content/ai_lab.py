    ...
    with t_masjid_v1:
        ...
        MASTER_KONTEN_ALL = {
            "🍉 Miniatur Dari Buah": {
                ...
                "Buah Naga: Tipe Relief Utuh (embedded design)": (
                    "An intricately carved miniature mosque embedded directly into the natural, whole spherical dragon fruit, placed on a high wooden table at chest-level. "
                    "The Mosque design is a precise geometric architectural relief carved **inward** into the fruit's pink skin, maintaining the overall round fruit volume. "
                    "The outer skin is bright pink with natural green-tipped scales, continuous and dominant. "
                    "The carved out sections of the relief reveal contrasting glistening white dragon fruit flesh filled with tiny natural black seeds, strictly with **no etched text or calligraphy.** "
                    "Featuring a central large dome and minarets that are shaped as parts of the surface carving, following the curved surface with precise architectural patterns. "
                    "Table clutter: Small, realistic white flesh fragments (with black seeds), seeds, and pink rind shavings scattered on the table surface. A full whole dragon fruit sits beside the miniature. "
                    "The completed miniature is positioned right under the character's chin, sharing the frame 50/50 with the character's torso and face. "
                    "Natural golden hour light focuses on the glistening moist texture of the white flesh with black seeds inside the recessed carvings. Zero LEDs, purely organic interaction with light."
                ),
                "Buah Naga: Tipe Kompleks Masjid (Grand Scale)": (
